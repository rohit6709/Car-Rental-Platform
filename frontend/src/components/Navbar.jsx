...
const Navbar = () => {
  ...
  const changeRole = async () => {
    try {
      ...
      toast.error("Could not switch to owner mode. Please log in first");
    }
  };
    ...
    >
      ...
      >
        <img
          ...
          alt="menu"
          className={`w-6 h-6 transition-transform transition-filter duration-150 filter ${
            open ? "scale-105 brightness-110 drop-shadow-sm" : ""
          }`}
        />
      </button>
    </div>
